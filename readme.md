...
```
Bu proje içerisinde her prensip için 2 adet örnek uygulama klasörleri oluşturulmuş olup 
her uygulama için de prensibin uygulanmış ve uygulanmamış hali olmak üzere iki adet class
oluşturulmuştur.
